...
public class P12CertTest {
    ...
    private final static String TEST_URL = "https://www.geelyapi.com:8088/server/ssl";
    ...
    public void getHKVesselTrip() throws Exception {
        ...
        // 加载客户端证书，即自己的私钥
        clientStore
                .load(new FileInputStream("E:\\project\\java\\springboot-https\\springboot-https-client\\src\\main\\resources\\client.p12"),
                        "123456".toCharArray());
        // 创建密钥管理工厂实例
        ...
        // 加载信任库，即服务端公钥
        trustStore.load(new FileInputStream("E:\\project\\java\\springboot-https\\springboot-https-client\\src\\main\\resources\\server.p12"),
                "123456".toCharArray());
        // 初始化信任库
        tmf.init(trustStore);
